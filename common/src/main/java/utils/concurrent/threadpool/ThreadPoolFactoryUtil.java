 ...
 * 创建ThreadPool的工具类
 * @author quincy
 * @create 2023 - 05 - 08 19:25
 */
@Slf4j
public class ThreadPoolFactoryUtil {

    /**
     * 通过threadNamePrefix 来区分不同线程池(我们可以把相同threadNamePrefix的线程池看作是为同一业务)
    ...
    /**
     * 如果缓存中存在就返回指定key就返回该线程池，否则创建并put新的线程池
    ...
    /**
     * 创建ThreadFactory.如果threadNamePredix不为空则使用自建ThreadFactory, 否则使用defaultThreadFactory
